...
pub struct IOUSBDeviceStruct942 {
    ...
    pub CreateDeviceAsyncEventSource:
        extern "C" fn(this: *mut Self, source: *mut CFRunLoopSourceRef) -> IOReturn,
    pub GetDeviceAsyncEventSource: extern "C" fn(this: *mut Self) -> CFRunLoopSourceRef,
    pub CreateDeviceAsyncPort: extern "C" fn(this: *mut Self, port: *mut mach_port_t) -> IOReturn,
    pub GetDeviceAsyncPort: extern "C" fn(this: *mut Self) -> mach_port_t,
    pub USBDeviceOpen: extern "C" fn(this: *mut Self) -> IOReturn,
    pub USBDeviceClose: extern "C" fn(this: *mut Self) -> IOReturn,
    pub GetDeviceClass: extern "C" fn(this: *mut Self, devClass: *mut UInt8) -> IOReturn,
    pub GetDeviceSubClass: extern "C" fn(this: *mut Self, devSubClass: *mut UInt8) -> IOReturn,
    pub GetDeviceProtocol: extern "C" fn(this: *mut Self, devProtocol: *mut UInt8) -> IOReturn,
    pub GetDeviceVendor: extern "C" fn(this: *mut Self, devVendor: *mut UInt16) -> IOReturn,
    pub GetDeviceProduct: extern "C" fn(this: *mut Self, devProduct: *mut UInt16) -> IOReturn,
    pub GetDeviceReleaseNumber: extern "C" fn(this: *mut Self, devRelNum: *mut UInt16) -> IOReturn,
    pub GetDeviceAddress: extern "C" fn(this: *mut Self, addr: *mut USBDeviceAddress) -> IOReturn,
    pub GetDeviceBusPowerAvailable:
        extern "C" fn(this: *mut Self, powerAvailable: *mut UInt32) -> IOReturn,
    pub GetDeviceSpeed: extern "C" fn(this: *mut Self, devSpeed: *mut UInt8) -> IOReturn,
    pub GetNumberOfConfigurations:
        extern "C" fn(this: *mut Self, numConfig: *mut UInt8) -> IOReturn,
    pub GetLocationID: extern "C" fn(this: *mut Self, locationID: *mut UInt32) -> IOReturn,
    pub GetConfigurationDescriptorPtr: extern "C" fn(
        this: *mut Self,
        configIndex: UInt8,
        desc: *mut IOUSBConfigurationDescriptorPtr,
    ) -> IOReturn,
    pub GetConfiguration: extern "C" fn(this: *mut Self, configNum: *mut UInt8) -> IOReturn,
    pub SetConfiguration: extern "C" fn(this: *mut Self, configNum: UInt8) -> IOReturn,
    pub GetBusFrameNumber:
        extern "C" fn(this: *mut Self, frame: *mut UInt64, atTime: *mut AbsoluteTime) -> IOReturn,
    pub ResetDevice: extern "C" fn(this: *mut Self) -> IOReturn,
    pub DeviceRequest: extern "C" fn(this: *mut Self, req: *mut IOUSBDevRequest) -> IOReturn,
    ...
    pub USBDeviceOpenSeize: extern "C" fn(this: *mut Self) -> IOReturn,
    pub DeviceRequestTO: extern "C" fn(this: *mut Self, req: *mut IOUSBDevRequestTO) -> IOReturn,
    ...
    pub USBDeviceSuspend: extern "C" fn(this: *mut Self, suspend: Boolean) -> IOReturn,
    pub USBDeviceAbortPipeZero: extern "C" fn(this: *mut Self) -> IOReturn,
    pub USBGetManufacturerStringIndex: extern "C" fn(this: *mut Self, msi: *mut UInt8) -> IOReturn,
    pub USBGetProductStringIndex: extern "C" fn(this: *mut Self, psi: *mut UInt8) -> IOReturn,
    pub USBGetSerialNumberStringIndex: extern "C" fn(this: *mut Self, snsi: *mut UInt8) -> IOReturn,
    pub USBDeviceReEnumerate: extern "C" fn(this: *mut Self, options: UInt32) -> IOReturn,
    ...
    pub GetBusFrameNumberWithTime:
        extern "C" fn(this: *mut Self, frame: *mut UInt64, atTime: *mut AbsoluteTime) -> IOReturn,
    pub GetUSBDeviceInformation: extern "C" fn(this: *mut Self, info: *mut UInt32) -> IOReturn,
    ...
    pub ReturnExtraPower:
        extern "C" fn(this: *mut Self, type_: UInt32, powerReturned: UInt32) -> IOReturn,
    pub GetExtraPowerAllocated:
        extern "C" fn(this: *mut Self, type_: UInt32, powerAllocated: *mut UInt32) -> IOReturn,
}
